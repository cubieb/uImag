...
(function ($) {
    $.fn.loadingRing = function () {
        ...
        var timer = setInterval(function () {
            ...
            $(".progress-ring>.progress-text>.progress-num").text(percent);
            $target.find('.progress-left').css({
                'transform': 'rotate(' + parseFloat(percent * 36)+ 'deg)',  //匀速运动的版本是将360度分成100份，变速运动的版本是将360度分成10份
                '-o-transform': 'rotate(' + parseFloat(percent * 36)+ 'deg)',
                '-ms-transform': 'rotate(' + parseFloat(percent * 36)+ 'deg)',
                '-moz-transform': 'rotate(' + parseFloat(percent * 36)+ 'deg)',
                '-webkit-transform': 'rotate(' + parseFloat(percent * 36)+ 'deg)',
        ...
        //
        //             if (percent > 50) {
        //                 var animation = 'toggle ' + (2000 * 50 / percent) + 'ms'
        //                 $target.find('.progress-right').css({
        //                     'opacity': 1,
        //                     'animation': animation,
        //                     'animation-timing-function': 'step-end'
        ...
        //     error: function () {
        //         console.log("刷入开发板flash成功......失败！");
        //     },
        //     success: function (res) {
        //         console.log(res);
        //         console.log("刷入开发板flash成功......成功！");
