...
#if (ENABLE_FLV_ENCODER||ENABLE_H263_ENCODER||ENABLE_H263P_ENCODER||ENABLE_RV10_ENCODER||ENABLE_RV20_ENCODER	\
		||ENABLE_MPEG4_ENCODER||ENABLE_MSMPEG4V1_ENCODER||ENABLE_MSMPEG4V2_ENCODER||ENABLE_MSMPEG4V3_ENCODER	\
		||ENABLE_WMV1_ENCODER)
    const int w = 8;
