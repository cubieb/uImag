...
#define BTUT_Logw(fmt, ...) BTUT_Log(BTUT_LOG_LV_WRN, "<W> %s(). " fmt , __FUNCTION__, ## __VA_ARGS__)
#define BTUT_Loge(fmt, ...) BTUT_Log(BTUT_LOG_LV_ERR, "<E> %s:%d %s(). " fmt , __FILE__, __LINE__, __FUNCTION__, ## __VA_ARGS__)
