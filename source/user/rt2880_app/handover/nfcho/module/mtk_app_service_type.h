...
#define MTK_NFC_START_HWTEST_ALSPOLL (0xC4)
#define MTK_NFC_STOP_HWTEST_ALSPOLL (0xC5)
...
#define MTK_NFC_HO_P2P_MAX_DATA         (300)  
...
int mtk_nfc_app_service_nfcmwdebug(unsigned char Enable);
