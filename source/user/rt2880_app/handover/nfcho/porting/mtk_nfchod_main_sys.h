...
#define MTK_NFCAPP_LOGD(...)  {printf(MONITOR_TAG_D); printf("%s: ",__func__);printf(__VA_ARGS__); printf("\n");}
...
#define MTK_WIFINFC_SET_START_FULL_POLL    (0x16)
#define MTK_WIFINFC_SET_STOP_FULL_POLL     (0x17)
#define MTK_WIFINFC_SET_END                (0x18)

#define MTK_WIFINFC_ENABLE_DGB             (0x50)
#define MTK_WIFINFC_DISABLE_DGB            (0x51)
